    ...
    public class Lyrics : StoryboardObjectGenerator
    {
        ...
        public void generatePerLine(FontGenerator font, SubtitleSet subtitles, StoryboardLayer layer, bool additive)
        {
            foreach (var line in subtitles.Lines)
            {
                ...
                sprite.Fade(line.StartTime, line.StartTime, 0, 1);
                sprite.Fade(line.EndTime - 200, line.EndTime, 1, 0);
                if (flip){
                    sprite.MoveX(OsbEasing.OutExpo, line.StartTime, line.StartTime + 200, -200, 240);
                    sprite.MoveX(line.StartTime + 200, line.EndTime - 200, 240, 320);
                    sprite.MoveX(OsbEasing.InExpo, line.EndTime - 200, line.EndTime, 320, 800);
                }else{
                    sprite.MoveX(OsbEasing.OutExpo, line.StartTime, line.StartTime + 200, 800, 400);
                    sprite.MoveX(line.StartTime + 200, line.EndTime - 200, 400, 320);
                    sprite.MoveX(OsbEasing.InExpo, line.EndTime - 200, line.EndTime, 320, -200);
                    sprite.Color(line.StartTime, 0.95, 0.77, 0.85);
                }
