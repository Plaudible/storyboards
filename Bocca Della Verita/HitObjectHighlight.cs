    ...
    public class HitObjectHighlight : StoryboardObjectGenerator
    {
        ...
        public override void Generate()
        {
            ...
            foreach (var hitobject in Beatmap.HitObjects)
            {
                ...
                hSprite.Color(hitobject.StartTime, 0.42, 0.052, 0.687);
                hSprite2.Color(hitobject.StartTime, 0.42, 0.052, 0.687);
                hSprite3.Color(hitobject.StartTime, 0.42, 0.052, 0.687);
