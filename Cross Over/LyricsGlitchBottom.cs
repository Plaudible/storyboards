...
{
    public class LyricsGlitchBottom : StoryboardObjectGenerator
    {
        [Configurable]
        ...
        public void generatePerLine(FontGenerator font, SubtitleSet subtitles, StoryboardLayer layer, bool additive)
        {
            foreach (var line in subtitles.Lines)
            {
                ...
                sprite.Fade(line.StartTime, line.EndTime - 200, 1, 0.5); 
                sprite.Fade(line.EndTime - 200, line.EndTime, 0.5, 0);
