                ...
                foreach (var line in subtitleLine.Text.Split('\n'))
                {
                    ...
                    foreach (var letter in line)
                    {
                        ...
                        if (!texture.IsEmpty)
                        {
                            ...
                            sprite.Fade(subtitleLine.StartTime + 107, subtitleLine.StartTime + 107, 1, 0);
                            sprite.Fade(subtitleLine.StartTime + 321, subtitleLine.StartTime + 321, 0, 1);
