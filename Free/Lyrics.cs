    ...
    public class Lyrics : StoryboardObjectGenerator
    {
        ...
        public void generatePerLine(FontGenerator font, SubtitleSet subtitles, StoryboardLayer layer, bool additive)
        {
            ...
            foreach (var line in subtitles.Lines)
            {
                ...
                sprite.Fade(line.StartTime - 100, line.StartTime + 100, 0, 1);
                sprite.Fade(line.EndTime - 100, line.EndTime + 100, 1, 0);
                if (bruh % 2 == 0){
                    sprite.MoveY(OsbEasing.OutExpo, line.StartTime, line.EndTime, 500, 400);
                    bruh++;
                }else{
                    sprite.MoveY(OsbEasing.OutExpo, line.StartTime, line.EndTime, 0, 100);
                    bruh++;
                }
