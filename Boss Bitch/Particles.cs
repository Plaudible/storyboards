        ...
        public override void Generate()
        {
            ...
            }))
            {
                ...
                for (var startTime = (double)StartTime; startTime <= EndTime - particleDuration; startTime += timeStep)
                {
                    ...
                    var sprite2 = pool.Get(startTime, endTime);
                    ...
                    sprite.MoveX(OsbEasing.InOutSine, startTime, endTime, startX - 50, endX + 50);
                    sprite2.MoveY(startTime, endTime, endY, startY);
                    sprite2.MoveX(OsbEasing.InOutSine, startTime, endTime, startX - 50, endX + 50);
