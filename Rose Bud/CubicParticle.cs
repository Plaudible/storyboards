...
{
    public class CubicParticle : StoryboardObjectGenerator
    {
        [Configurable]
        public string Path = "sb/glow.png";
        ...
        public override void Generate()
        {
            ...
            }))
            {
                ...
                for (var startTime = (double)StartTime; startTime <= EndTime - particleDuration; startTime += timeStep)
                {
                    ...
                    sprite.MoveX(easing, startTime, endTime, startX, endX);
                    sprite.MoveY(OsbEasing.InOutExpo, startTime, endTime, startY, endY);
